"use client"
import { abbyBio, abbyImage, abbyLink, abbyName } from "@/data/abbyData/data"
...
const InfoCard: React.FC = () => {
  ...
  const socialLink = isSwitchOn ? abbyLink : profileLink
  return (
    <section>
      <div className=" flex flex-col gap-2">
        ...
        <div className="flex gap-3 items-center">
          ...
          >
            <Image
              src={isSwitchOn ? abbyImage : profileImage}
              alt="Profile Picture"
              className="pro-pic"
              width={200}
              height={200}
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-4 items-center">
              <h1 className=" head-name ">
                {isSwitchOn ? abbyName : profileName}
              </h1>
              <div className=" md:block hidden">
                <Available text="Available" />
              </div>
            </div>
            <p>{isSwitchOn ? abbyBio : profileBio}</p>
