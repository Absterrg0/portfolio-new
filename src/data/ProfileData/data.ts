...
const profileAbout = `
  ...
  <p>
    I'm currently working on <strong> <a href="https://app.okito.dev/" target="_blank"> Okito</a></strong> - a next-generation Web3 payment gateway and SDK built on Solana. My focus is on creating developer-friendly tools that make crypto payments as simple as traditional payment methods.
  </p>
  <p>
...
const profileContact =
  "I'm also super active on X, so feel free to DM me there or reach out to me via email if you have any queries."
